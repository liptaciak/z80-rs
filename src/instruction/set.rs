...
pub enum Instruction {
    ...
    _RETNZ, _POPBC, JPNZNN, JPNN, CALLNZNN, _PUSHBC, ADDAN, _RST00H, _RETZ, RET, JPZNN, _BITSET, _CALLZNN, CALLNN, _ADCAN, _RST08H,
    _RETNC, _POPDE, JPNCNN, OUTNA, _CALLNCNN, _PUSHDE, SUBN, _RST10H, _RETC, _EXX, JPCNN, INAN, _CALLCNN, _IXSET, _SBCAN, _RST18H,
    RETPO, _POPHL, JPPONN, _EXSPHL, _CALLPONN, _PUSHHL, ANDN, _RST20H, _RETPE, _JPHLM, JPPENN, _EXDEHL, _CALLPENN, _MISCSET, _XORN, _RST28H,
    _RETP, _POPAF, JPPNN, DI, _CALLPNN, _PUSHAF, _ORN, _RST30H, _RETM, _LDSPHL, JPMNN, EI, _CALLMNN, _IYSET, CPN, _RST38H, 
}
...
pub const INSTRUCTIONS: [(Instruction, AddressMode); 0x100] = [
    ...
    (Instruction::JPNZNN, AddressMode::Extended), (Instruction::JPNN, AddressMode::Extended),
    ...
    (Instruction::JPNCNN, AddressMode::Extended), (Instruction::OUTNA, AddressMode::Immediate),
    ...
    (Instruction::JPCNN, AddressMode::Extended), (Instruction::INAN, AddressMode::Immediate),
    ...
    (Instruction::JPPONN, AddressMode::Extended), (Instruction::_EXSPHL, AddressMode::None),
    (Instruction::_CALLPONN, AddressMode::ImmediateExtended), (Instruction::_PUSHHL, AddressMode::None), 
    (Instruction::ANDN, AddressMode::Immediate), (Instruction::_RST20H, AddressMode::None),
    (Instruction::_RETPE, AddressMode::None), (Instruction::_JPHLM, AddressMode::None), 
    (Instruction::JPPENN, AddressMode::Extended), (Instruction::_EXDEHL, AddressMode::None),
    ...
    (Instruction::JPPNN, AddressMode::Extended), (Instruction::DI, AddressMode::None),
    ...
    (Instruction::JPMNN, AddressMode::Extended), (Instruction::EI, AddressMode::None),
